  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <input
                ...
                border-gray-300 
                px-2 py-1 bg-white placeholder-gray-400
                text-black
      ...
      <div data-aos="zoom-in" className="flex justify-center">
        <ul className="sm:flex hidden items-center gap-4 max-md:text-sm">
          {Menu.map((data) => (
            <li key={data.id}>
              <a
                href={data.link}
          ...
          <li className="group relative cursor-pointer">
            <a
              href="#"
              className="
              flex items-center gap-[2px] py-2
              "
            >
              Trending
              <span>
